function ripple() {
  ...
  haveRipples.forEach((hasRipple) => {
    ...
    container.addEventListener("click", (e) => {
      ...
      rippleItem.style.top = `${e.pageY - (container.getBoundingClientRect().top + scrollY) - radius}px`;
      rippleItem.style.left = `${e.pageX - (container.getBoundingClientRect().left + scrollX) - radius}px`;
