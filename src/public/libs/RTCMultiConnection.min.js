...
var RTCMultiConnection = function (roomid, forceOptions) {
  function SocketConnection(connection, connectCallback) {
    ...
    function updateExtraBackup(remoteUserId, extra) {
      connection.peersBackup[remoteUserId] ||
        (connection.peersBackup[remoteUserId] = { userid: remoteUserId, extra: {} }),
    ...
    function onMessageEvent(message) {
      if (message.remoteUserId == connection.userid) {
        ...
        if (
          ...
          (connection.attachStreams.length && (connection.waitingForLocalMedia = !1),
        ...
        return (
          ...
          message.message.userLeft
            ? (mPeer.onUserLeft(message.sender),
              void (message.message.autoCloseEntireSession && connection.leave()))
  ...
  function getRandomString() {
    if (
      ...
      for (
        var a = window.crypto.getRandomValues(new Uint32Array(3)), token = "", i = 0, l = a.length;
        i < l;
        i++
      )
    ...
    try {
      ...
      try {
        ...
        isUnifiedPlanSupported =
          "unified-plan" == config.sdpSemantics || ("plan-b" == config.sdpSemantics, !1);
      } catch (e) {
    ...
    if (
      ...
      (window.webkitRTCPeerConnection = iosrtc.RTCPeerConnection),
        ...
        "function" == typeof iosrtc.selectAudioOutput &&
          iosrtc.selectAudioOutput(window.iOSDefaultAudioOutputDevice || "speaker"),
  ...
  !(function (that) {
    that &&
      ...
      "undefined" == typeof location &&
        (that.location = { protocol: "file:", href: "", hash: "", origin: "self" }),
    ...
    (function () {
      ...
      function detectDesktopOS() {
        ...
        switch (
          (/Windows/.test(os) &&
            (/Windows (.*)/.test(os) && (osVersion = /Windows (.*)/.exec(os)[1]), (os = "Windows")),
          os)
        ) {
          case "Mac OS X":
        ...
        function handleCandidate(candidate) {
          ...
          if (match) {
            var ipAddress = match[1],
              ...
              isIpv4 = !0;
            void 0 === ipDuplicates[ipAddress] && callback(ipAddress, isPublic, isIpv4),
      ...
      "Unknown OS" === osName &&
        isNodejs &&
        ((osName = "Nodejs"), (osVersion = process.versions.node.toString().replace("v", "")));
      ...
      if (
        ...
        var isNonLocalHost =
          ...
          document.domain.search(/localhost|127.0./g) === -1;
        isNonLocalHost &&
        (DetectRTC.browser.isChrome || DetectRTC.browser.isEdge || DetectRTC.browser.isOpera)
      ...
      (DetectRTC.displayResolution = displayResolution),
        ...
        "Nodejs" === DetectRTC.osName &&
          ((DetectRTC.isWebSocketsSupported = !0), (DetectRTC.isWebSocketsBlocked = !1)),
  ...
  var RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription,
    ...
    CodecsHandler = (function () {
      ...
      function findLineInRange(sdpLines, startLine, endLine, prefix, substr) {
        for (
          var realEndLine = endLine !== -1 ? endLine : sdpLines.length, i = startLine;
          i < realEndLine;
          ++i
        )
          if (
      ...
      function setOpusAttributes(sdp, params) {
        ...
        return (
          (appendOpusNext +=
            "; stereo=" + ("undefined" != typeof params.stereo ? params.stereo : "1")),
          (appendOpusNext +=
            "; sprop-stereo=" +
            ("undefined" != typeof params["sprop-stereo"] ? params["sprop-stereo"] : "1")),
          ...
          "undefined" != typeof params.maxplaybackrate &&
            (appendOpusNext += "; maxplaybackrate=" + (params.maxplaybackrate || 1048576)),
          "undefined" != typeof params.cbr &&
            (appendOpusNext += "; cbr=" + ("undefined" != typeof params.cbr ? params.cbr : "1")),
    ...
    TextSender = {
      send: function (config) {
        function sendText(textMessage, text) {
          ...
          textMessage &&
            ((text = textMessage), (data.packets = parseInt(text.length / packetSize))),
  ...
  !(function (connection) {
    ...
    function joinRoom(connectionDescription, cb) {
      connection.socket.emit(
        "join-room",
        {
          ...
          password:
            "undefined" != typeof connection.password && "object" != typeof connection.password
              ? connection.password
              : "",
        },
    ...
    (mPeer.onGettingLocalMedia = function (stream, callback) {
      if (
        ((callback = callback || function () {}), preventDuplicateOnStreamEvents[stream.streamid])
      )
      ...
      (connection.deletePeer = function (remoteUserId) {
        if (remoteUserId && connection.peers[remoteUserId]) {
          ...
          if (
            ...
            connection.peers[remoteUserId] &&
              ((connection.peers[remoteUserId].peer = null), delete connection.peers[remoteUserId]);
          }
        }
      }),
          ...
          return connection.dontCaptureUserMedia || isData(session)
            ...
            : void (
                ...
                (session.screen
                  ? "Edge" === DetectRTC.browser.name
                    ? navigator
                        .getDisplayMedia({ video: !0, audio: isAudioPlusTab(connection) })
                        .then(
                          function (screen) {
                            if (
                              ((screen.isScreen = !0),
      ...
      window.ignoreBeforeUnload
        ...
        : ((connection.closeBeforeUnload = !0),
          window.addEventListener("beforeunload", connection.onbeforeunload, !1)),
        ...
        DetectRTC.load(function () {
          ...
          if (
            ...
            1 == connection.mediaConstraints.audio &&
              (connection.mediaConstraints.audio = { mandatory: {}, optional: [] }),
          ...
          if (lastVideoDevice) {
            ...
            1 == connection.mediaConstraints.video &&
              (connection.mediaConstraints.video = { mandatory: {}, optional: [] }),
      ...
      (connection.acceptParticipationRequest = function (participantId, userPreferences) {
        userPreferences.successCallback &&
          (userPreferences.successCallback(), delete userPreferences.successCallback),
        ...
        (StreamsHandler.onSyncNeeded = function (streamid, action, type) {
          connection.peers.getAllParticipants().forEach(function (participant) {
            mPeer.onNegotiationNeeded(
              { streamid: streamid, action: action, streamSyncNeeded: !0, type: type || "both" },
              participant
            );
          });
        }),
