...
!(function () {
  ...
  function copy() {
    endLastPath(),
      ...
      find("copy-last").checked
        ...
        : ((copiedStuff = points), setSelection(find("drag-all-paths"), "DragAllPaths"));
  }
  function paste() {
    endLastPath(),
      (dragHelper.global.startingIndex = 0),
      find("copy-last").checked
        ? ((points[points.length] = copiedStuff),
          (dragHelper.global = { prevX: 0, prevY: 0, startingIndex: points.length - 1 }),
  ...
  function clone(obj) {
    ...
    for (var key in obj)
      Object.prototype.hasOwnProperty.call(obj, key) &&
        ((obj.isActiveClone = null), (temp[key] = clone(obj[key])), delete obj.isActiveClone);
    return temp;
  }
  function hexToRGB(h) {
  ...
  function setSelection(element, prop) {
    ...
    selected && (selected.className = selected.className.replace(/selected-shape/g, "")),
  ...
  function setDefaultSelectedIcon() {
    ...
    firstMatch ||
      ((window.selectedIcon = "Pencil"), (firstMatch = document.getElementById("pencil-icon"))),
  ...
  function hideContainers() {
    ...
    additionalContainer.style.display =
      ...
      lineWidthContainer.style.display =
        "none";
  }
  ...
  function onkeyup(e) {
    return (
      ...
      13 === (keyCode = e.which || e.keyCode || 0) && is.isText
        ...
        ? void (isBackKey(e, keyCode) && textHandler.writeText(textHandler.lastKeyPress, !0))
        ...
        : (isControlKeyPressed &&
          ...
          void 0 !== e.metaKey && !1 === e.metaKey && ((isControlKeyPressed = !1), (keyCode = 17)),
  ...
  function onkeypress(e) {
    null != e.which ||
      ...
      /[a-zA-Z0-9-_ !?|\/'",.=:;(){}\[\]`~@#$%^&*+-]/.test(String.fromCharCode(keyCode)) &&
  ...
  function syncPoints(isSyncAll) {
    if ((isSyncAll && (lastPointIndex = 0), lastPointIndex != points.length)) {
      ...
      pointsToShare.length && syncData({ points: pointsToShare || [], startIndex: lastPointIndex }),
        (!pointsToShare.length && points.length) || (lastPointIndex = points.length);
    }
  }
  function syncData(data) {
    console.log({ canvasDesignerSyncData: data, uid: uid });
    window.parent.postMessage({ canvasDesignerSyncData: data, uid: uid }, "*");
  }
    ...
    common = {
      updateTextArea: function () {
        ...
        isAbsolutePoints && isShortenCode && c.absoluteShortened(),
          ...
          !isAbsolutePoints && isShortenCode && c.relativeShortened(toFixed, getPoint),
      ...
      absoluteShortened: function () {
        var point,
          ...
          i = 0;
        for (i; i < length; i++)
          (point = points[i]), (output += this.shortenHelper(point[0], point[1], point[2]));
        ...
        for (i; i < length; i++)
          (p = points[i]),
            ...
            "text" === p[0] &&
              (output += this.shortenHelper(
                p[0],
                [point[0], getPoint(point[1], x, "x"), getPoint(point[2], y, "y")],
                p[2]
              )),
            "arc" === p[0] &&
              (output += this.shortenHelper(
      ...
      strokeOrFill: function (p) {
        return this.prevProps && this.prevProps === p.join(",")
          ? "strokeOrFill();"
          : ((this.prevProps = p.join(",")), "strokeOrFill('" + p.join("', '") + "');");
      },
      prevProps: null,
      shortenHelper: function (name, p1, p2) {
        ...
        return (
          (this.prevProps && this.prevProps === p2.join(",")) ||
            ((this.prevProps = p2.join(",")), (result += ", ['" + p2.join("', '") + "']")),
          result + "], "
        );
      },
    },
      ...
      mousedown: function (e) {
        ...
        if (((g.prevX = x), (g.prevY = y), (g.pointsToMove = "all"), points.length)) {
          var p = points[points.length - 1],
            point = p[1];
          "line" === p[0] &&
            (dHelper.isPointInPath(x, y, point[0], point[1]) && (g.pointsToMove = "head"),
            dHelper.isPointInPath(x, y, point[2], point[3]) && (g.pointsToMove = "tail")),
            "arrow" === p[0] &&
              (dHelper.isPointInPath(x, y, point[0], point[1]) && (g.pointsToMove = "head"),
              dHelper.isPointInPath(x, y, point[2], point[3]) && (g.pointsToMove = "tail")),
            "rect" === p[0] &&
        ...
        if (points.length) {
          ...
          this.global.ismousedown
            ...
            "rect" === p[0] &&
              ...
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(point[0] + point[2], point[1], 10, 2 * Math.PI, 0, !1),
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(point[0], point[1] + point[3], 10, 2 * Math.PI, 0, !1),
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(point[0] + point[2], point[1] + point[3], 10, 2 * Math.PI, 0, !1),
              tempContext.fill()),
            "image" === p[0] &&
              (tempContext.beginPath(),
              ...
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(point[1] + point[3], point[2], 10, 2 * Math.PI, 0, !1),
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(point[1], point[2] + point[4], 10, 2 * Math.PI, 0, !1),
              tempContext.fill(),
              tempContext.beginPath(),
              tempContext.arc(point[1] + point[3], point[2] + point[4], 10, 2 * Math.PI, 0, !1),
              tempContext.fill()),
            "pdf" === p[0] &&
              (tempContext.beginPath(),
              tempContext.arc(point[1], point[2], 10, 2 * Math.PI, 0, !1),
      ...
      getXYWidthHeight: function (x, y, prevX, prevY, oldPoints) {
        return (
          ...
          "stretch-second" == oldPoints.pointsToMove &&
            ((oldPoints.width =
              x > prevX ? oldPoints.width + (x - prevX) : oldPoints.width - (prevX - x)),
            y < prevY
              ? ((oldPoints.y = oldPoints.y + (y - prevY)),
                (oldPoints.height = oldPoints.height - (y - prevY)))
              : ((oldPoints.y = oldPoints.y - (prevY - y)),
          ...
          "stretch-third" == oldPoints.pointsToMove &&
            (x > prevX
              ...
              : ((oldPoints.x = oldPoints.x - (prevX - x)),
                (oldPoints.width = oldPoints.width + (prevX - x))),
            (oldPoints.height =
              y < prevY ? oldPoints.height + (y - prevY) : oldPoints.height - (prevY - y))),
          oldPoints
        );
      },
        ...
        for (i; i < length; i++)
          (p = points[i]),
            ...
            "text" === p[0] &&
              (points[i] = [
                p[0],
                [point[0], getPoint(x, prevX, point[1]), getPoint(y, prevY, point[2])],
                p[2],
              ]),
            "arc" === p[0] &&
              (points[i] = [
            ...
            "rect" === p[0] &&
              (points[i] = [
                p[0],
                [getPoint(x, prevX, point[0]), getPoint(y, prevY, point[1]), point[2], point[3]],
                p[2],
              ]),
            "image" === p[0] &&
              (points[i] = [
  ...
  var eraserHandler = {
    ...
    textHandler = {
      ...
      onShapeUnSelected: function () {
        (this.text = ""),
          ...
          void 0 !== this.blinkCursorInterval && clearInterval(this.blinkCursorInterval);
      },
      getFillColor: function (color) {
        return (
          (color = (color || fillStyle).toLowerCase()),
          "rgba(255, 255, 255, 0)" == color || "transparent" == color || "white" === color
            ? "black"
            : color
        );
      },
      ...
      fillText: function (text) {
        if (is.isText) {
          ...
          drawHelper.handleOptions(tempContext, options),
            ...
            (tempContext.font =
              textHandler.selectedFontSize + 'px "' + textHandler.selectedFontFamily + '"'),
      ...
      showOrHideTextTools: function (show) {
        "hide" === show
          ...
          : this.lastFillStyle.length || ((this.lastFillStyle = fillStyle), (fillStyle = "black")),
      ...
      eachFontFamily: function (callback) {
        for (var childs = this.fontFamilyBox.querySelectorAll("li"), i = 0; i < childs.length; i++)
          callback(childs[i]);
      },
      ...
      eachFontSize: function (callback) {
        for (var childs = this.fontSizeBox.querySelectorAll("li"), i = 0; i < childs.length; i++)
          callback(childs[i]);
      },
      ...
      onReturnKeyPressed: function () {
        if (textHandler.text && textHandler.text.length) {
          ...
          this.mousedown({ pageX: this.pageX, pageY: this.pageY + fontSize + 5 }),
            drawHelper.redraw();
        }
      },
    ...
    arcHandler = {
      ...
      mousemove: function (e) {
        ...
        if (ismousedown && !isCircleDrawn && isCircleEnded) {
          ...
          tempContext.clearRect(0, 0, 2e3, 2e3),
            drawHelper.arc(tempContext, [prevX + radius, prevY + radius, radius, 2 * Math.PI, !0]);
        }
      },
      ...
      arcRangeHandler: function (e) {
        ...
        if (
          ((39 != key && 40 != key) || (arcRange.value = (value < 2 ? value : 1.98) + 0.02),
          (37 != key && 38 != key) || (arcRange.value = (value > 0 ? value : 0.02) - 0.02),
  ...
  var lineHandler = {
    ...
    quadraticHandler = {
      ...
      mouseup: function (e) {
        ...
        g.ismousedown &&
          g.isFirstStep &&
          ((g.controlPointX = x), (g.controlPointY = y), (g.isFirstStep = !1), (g.isLastStep = !0));
      },
      mousemove: function (e) {
        var x = e.pageX - canvas.offsetLeft,
          y = e.pageY - canvas.offsetTop,
        ...
        (file.type = "file"),
          ...
          (file.onchange = function () {
            return multiple
              ...
              : file.files[0]
              ? (callback(file.files[0]), void file.parentNode.removeChild(file))
              : void console.error("No file selected.");
          }),
    ...
    imageHandler = {
      ...
      load: function (width, height) {
        ...
        (points[points.length] = [
          "image",
          [imageHandler.lastImageURL, t.prevX, t.prevY, width, height, imageHandler.lastImageIndex],
          drawHelper.getOptions(),
        ]),
    ...
    pdfHandler = {
      ...
      getPage: function (pageNumber, callback) {
        if (((pageNumber = parseInt(pageNumber) || 1), !pdfHandler.pdf))
          return (
            ...
            void pdfjsLib.getDocument(pdfHandler.lastPdfURL).then(function (pdf) {
        ...
        pdf.getPage(pageNumber).then(function (page) {
          ...
          !0 === pdfHandler.removeWhiteBackground && (renderContext.background = "rgba(0,0,0,0)"),
            ...
            function (lastPage, width, height, numPages) {
              ...
              for (var i = 1; i <= numPages; i++) {
                ...
                (option.value = i),
                  ...
                  pdfHandler.pageNumber.toString() == i.toString() && (option.selected = !0);
              }
      ...
      reset_pos: function (x, y) {
        if (
          ((pdfHandler.pdfPageContainer.style.top = y + "px"), points[pdfHandler.lastPointIndex])
        ) {
  ...
  !0 === tools.code && (document.querySelector(".preview-panel").style.display = "block"),
    ...
    (function () {
      ...
      function bindEvent(context, shape) {
        ("Pencil" !== shape && "Marker" !== shape) || (lineCap = lineJoin = "round"),
          addEvent(context.canvas, "click", function () {
            if (
              (textHandler.text.length && textHandler.appendPoints(),
              "Text" === shape ? textHandler.onShapeSelected() : textHandler.onShapeUnSelected(),
              ("Pencil" !== shape && "Marker" !== shape) || (lineCap = lineJoin = "round"),
              (dragHelper.global.startingIndex = 0),
              setSelection(this, shape),
              "drag-last-path" === this.id
                ? ((find("copy-last").checked = !0), (find("copy-all").checked = !1))
                : "drag-all-paths" === this.id &&
                  ((find("copy-all").checked = !0), (find("copy-last").checked = !1)),
              "image-icon" === this.id)
            ) {
            ...
            "pencil-icon" === this.id || "eraser-icon" === this.id || "marker-icon" === this.id
        ...
        (image.onload = function () {
          context.drawImage(image, 4, 4, 32, 32),
            (document.querySelector("#undo").onclick = function () {
              points.length && ((points.length = points.length - 1), drawHelper.redraw()),
                syncPoints(!0);
            });
        }),
      ...
      (find("tool-box").style.height = innerHeight + "px"),
        ...
        !0 === tools.line &&
          (decorateLine(), (document.getElementById("line").style.display = "block")),
        !0 === tools.undo &&
          (decorateUndo(), (document.getElementById("undo").style.display = "block")),
        !0 === tools.arrow &&
          (decorateArrow(), (document.getElementById("arrow").style.display = "block")),
        !0 === tools.zoom &&
          (decoreZoomUp(),
          decoreZoomDown(),
        ...
        !0 === tools.pencil &&
          (decoratePencil(), (document.getElementById("pencil-icon").style.display = "block")),
        !0 === tools.marker &&
          (decorateMarker(), (document.getElementById("marker-icon").style.display = "block")),
        !0 === tools.eraser &&
          (decorateEraser(), (document.getElementById("eraser-icon").style.display = "block")),
        !0 === tools.text &&
          (decorateText(), (document.getElementById("text-icon").style.display = "block")),
        !0 === tools.image &&
          (decorateImage(), (document.getElementById("image-icon").style.display = "block")),
        !0 === tools.pdf &&
          (decoratePDF(), (document.getElementById("pdf-icon").style.display = "block")),
        !0 === tools.arc &&
          (decorateArc(), (document.getElementById("arc").style.display = "block")),
        !0 === tools.rectangle &&
          (decorateRect(), (document.getElementById("rectangle").style.display = "block")),
        !0 === tools.quadratic &&
          (decorateQuadratic(),
          (document.getElementById("quadratic-curve").style.display = "block")),
        !0 === tools.bezier &&
          (decorateBezier(), (document.getElementById("bezier-curve").style.display = "block")),
        !0 === tools.lineWidth &&
          (decorateLineWidth(), (document.getElementById("line-width").style.display = "block")),
        !0 === tools.colorsPicker &&
          (decorateColors(), (document.getElementById("colors").style.display = "block")),
      ...
      (window.selectBtn = function (btn, isSkipWebRTCMessage) {
        (codePreview.className = designPreview.className = ""),
          ...
          !isSkipWebRTCMessage && window.connection && connection.numberOfConnectedUsers >= 1
            ? connection.send({ btnSelected: btn.id })
            : btn == designPreview
      ...
      if (event.data) {
        if ((uid || (uid = event.data.uid), event.data.captureStream))
          return void webrtcHandler.createOffer(function (sdp) {
            console.log(sdp + "dwqqqqqqqqqqqqqqqqqqqq");
        ...
        if (event.data.genDataURL) {
          ...
          return void window.parent.postMessage({ dataURL: dataURL, uid: uid }, "*");
        }
        if (event.data.undo && points.length) {
          ...
          if (-1 === index)
            return (points.length = points.length - 1), drawHelper.redraw(), void syncPoints(!0);
          if (points[index]) {
    ...
    createOffer: function (callback) {
      ...
      captureStream.getTracks().forEach(function (track) {
        ...
        (peer.onicecandidate = function (event) {
          event &&
            !event.candidate &&
            callback({ sdp: peer.localDescription.sdp, type: peer.localDescription.type });
        }),
        peer.createOffer({ OfferToReceiveAudio: !1, OfferToReceiveVideo: !1 }).then(function (sdp) {
    ...
    createAnswer: function (sdp, callback) {
      ...
      (peer.onicecandidate = function (event) {
        ...
        (peer.ontrack = function (event) {
          callback({ stream: event.streams[0] });
        });
    },
    getPeer: function () {
